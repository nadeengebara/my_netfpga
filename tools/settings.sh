...
export SUME_FOLDER=/home/nadeen/SIGCOMM/PANAMA/Vivado/my_netfpga
...
export IP_FOLDER=${SUME_FOLDER}/lib/my_hw/std/cores
export CONSTRAINTS=${SUME_FOLDER}/lib/my_hw/std/constraints
export XILINX_IP_FOLDER=${SUME_FOLDER}/lib/myhw/xilinx/cores
