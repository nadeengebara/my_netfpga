...
ipx::add_subcore user.org:user:fp_unit:1.0 [ipx::get_file_groups  xilinx_anylanguagesynthesis -of_objects [ipx::current_core] ]
ipx::add_subcore user.org:user:fp_unit:1.0 [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]
