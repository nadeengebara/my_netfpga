...
#IP BUILD
read_verilog "./hdl/fp_datapath.v"
...
ipx::add_subcore NetFPGA:NetFPGA:fp_adder:1.00 [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]
ipx::add_subcore NetFPGA:NetFPGA:fp_adder:1.00 [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]
ipx::infer_user_parameters [ipx::current_core]
...
set_property value {0x3} [ipx::get_user_parameters PORTS_BITMAP]
