...
HD_PWD='/home/nadeen/SIGCOMM/PANAMA/Vivado/my_netfpga/projects/reference_switch_lite/hw/project/reference_switch_lite.runs/result_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log result_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source result_fifo.tcl
