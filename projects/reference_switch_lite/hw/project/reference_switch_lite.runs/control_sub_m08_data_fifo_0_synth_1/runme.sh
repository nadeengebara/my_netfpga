...
HD_PWD='/home/nadeen/SIGCOMM/PANAMA/Vivado/my_netfpga/projects/reference_switch_lite/hw/project/reference_switch_lite.runs/control_sub_m08_data_fifo_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log control_sub_m08_data_fifo_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source control_sub_m08_data_fifo_0.tcl
