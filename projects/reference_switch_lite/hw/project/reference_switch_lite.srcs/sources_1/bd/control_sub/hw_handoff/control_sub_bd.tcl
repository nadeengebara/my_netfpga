...
proc create_hier_cell_mbsys { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" create_hier_cell_mbsys() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_nf_mbsys { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" create_hier_cell_nf_mbsys() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_dma_sub { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" create_hier_cell_dma_sub() - Empty argument(s)!"}
     return
  }
...
CONFIG.MAX_BURST_LENGTH {1} \
 ] [get_bd_intf_pins /dma_sub/nf_riffa_dma_1/m_axi_lite]

  set_property -dict [ list \
CONFIG.TDATA_NUM_BYTES {16} \
CONFIG.TUSER_WIDTH {128} \
CONFIG.HAS_TKEEP {1} \
 ] [get_bd_intf_pins /dma_sub/nf_riffa_dma_1/m_axis_xge_tx]

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /dma_sub/nf_riffa_dma_1/s_axi_lite]

  set_property -dict [ list \
CONFIG.HAS_TKEEP {1} \
 ] [get_bd_intf_pins /dma_sub/nf_riffa_dma_1/s_axis_cc]

  set_property -dict [ list \
CONFIG.HAS_TKEEP {1} \
 ] [get_bd_intf_pins /dma_sub/nf_riffa_dma_1/s_axis_rq]
...
CONFIG.xlnx_ref_board {None} \
  ...
  # Need to retain value_src of defaults
  set_property -dict [ list \
CONFIG.PF0_MSIX_CAP_PBA_OFFSET.VALUE_SRC {DEFAULT} \
CONFIG.PF0_MSIX_CAP_TABLE_OFFSET.VALUE_SRC {DEFAULT} \
CONFIG.PF0_MSIX_CAP_TABLE_SIZE.VALUE_SRC {DEFAULT} \
CONFIG.PF1_CLASS_CODE.VALUE_SRC {DEFAULT} \
CONFIG.PF1_MSIX_CAP_PBA_OFFSET.VALUE_SRC {DEFAULT} \
CONFIG.PF1_MSIX_CAP_TABLE_OFFSET.VALUE_SRC {DEFAULT} \
CONFIG.PF1_MSIX_CAP_TABLE_SIZE.VALUE_SRC {DEFAULT} \
CONFIG.VF0_MSIX_CAP_PBA_OFFSET.VALUE_SRC {DEFAULT} \
CONFIG.VF0_MSIX_CAP_TABLE_OFFSET.VALUE_SRC {DEFAULT} \
CONFIG.VF0_MSIX_CAP_TABLE_SIZE.VALUE_SRC {DEFAULT} \
CONFIG.VF1_MSIX_CAP_PBA_OFFSET.VALUE_SRC {DEFAULT} \
CONFIG.VF1_MSIX_CAP_TABLE_OFFSET.VALUE_SRC {DEFAULT} \
CONFIG.VF1_MSIX_CAP_TABLE_SIZE.VALUE_SRC {DEFAULT} \
CONFIG.VF2_MSIX_CAP_PBA_OFFSET.VALUE_SRC {DEFAULT} \
CONFIG.VF2_MSIX_CAP_TABLE_OFFSET.VALUE_SRC {DEFAULT} \
CONFIG.VF2_MSIX_CAP_TABLE_SIZE.VALUE_SRC {DEFAULT} \
CONFIG.VF3_MSIX_CAP_PBA_OFFSET.VALUE_SRC {DEFAULT} \
CONFIG.VF3_MSIX_CAP_TABLE_OFFSET.VALUE_SRC {DEFAULT} \
CONFIG.VF3_MSIX_CAP_TABLE_SIZE.VALUE_SRC {DEFAULT} \
CONFIG.VF4_MSIX_CAP_PBA_OFFSET.VALUE_SRC {DEFAULT} \
CONFIG.VF4_MSIX_CAP_TABLE_OFFSET.VALUE_SRC {DEFAULT} \
CONFIG.VF4_MSIX_CAP_TABLE_SIZE.VALUE_SRC {DEFAULT} \
CONFIG.VF5_MSIX_CAP_PBA_OFFSET.VALUE_SRC {DEFAULT} \
CONFIG.VF5_MSIX_CAP_TABLE_OFFSET.VALUE_SRC {DEFAULT} \
CONFIG.VF5_MSIX_CAP_TABLE_SIZE.VALUE_SRC {DEFAULT} \
CONFIG.gen_x0y1.VALUE_SRC {DEFAULT} \
CONFIG.pf1_bar0_enabled.VALUE_SRC {DEFAULT} \
CONFIG.pf1_bar0_type.VALUE_SRC {DEFAULT} \
 ] $pcie3_7x_1
...
CONFIG.POLARITY {ACTIVE_HIGH} \
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x44000000 [get_bd_addr_spaces dma_sub/nf_riffa_dma_1/m_axi_lite] [get_bd_addr_segs M00_AXI/Reg] SEG_M00_AXI_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x44010000 [get_bd_addr_spaces dma_sub/nf_riffa_dma_1/m_axi_lite] [get_bd_addr_segs M01_AXI/Reg] SEG_M01_AXI_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x44020000 [get_bd_addr_spaces dma_sub/nf_riffa_dma_1/m_axi_lite] [get_bd_addr_segs M02_AXI/Reg] SEG_M02_AXI_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x44030000 [get_bd_addr_spaces dma_sub/nf_riffa_dma_1/m_axi_lite] [get_bd_addr_segs M03_AXI/Reg] SEG_M03_AXI_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x44040000 [get_bd_addr_spaces dma_sub/nf_riffa_dma_1/m_axi_lite] [get_bd_addr_segs M04_AXI/Reg] SEG_M04_AXI_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x44050000 [get_bd_addr_spaces dma_sub/nf_riffa_dma_1/m_axi_lite] [get_bd_addr_segs M05_AXI/Reg] SEG_M05_AXI_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x44060000 [get_bd_addr_spaces dma_sub/nf_riffa_dma_1/m_axi_lite] [get_bd_addr_segs dma_sub/nf_riffa_dma_1/s_axi_lite/reg0] SEG_nf_riffa_dma_1_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x40800000 [get_bd_addr_spaces nf_mbsys/mbsys/microblaze_0/Data] [get_bd_addr_segs nf_mbsys/axi_iic_0/S_AXI/Reg] SEG_axi_iic_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x40600000 [get_bd_addr_spaces nf_mbsys/mbsys/microblaze_0/Data] [get_bd_addr_segs nf_mbsys/axi_uartlite_0/S_AXI/Reg] SEG_axi_uartlite_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x00000000 [get_bd_addr_spaces nf_mbsys/mbsys/microblaze_0/Data] [get_bd_addr_segs nf_mbsys/mbsys/microblaze_0_local_memory/dlmb_bram_if_cntlr/SLMB/Mem] SEG_dlmb_bram_if_cntlr_Mem
  create_bd_addr_seg -range 0x00010000 -offset 0x00000000 [get_bd_addr_spaces nf_mbsys/mbsys/microblaze_0/Instruction] [get_bd_addr_segs nf_mbsys/mbsys/microblaze_0_local_memory/ilmb_bram_if_cntlr/SLMB/Mem] SEG_ilmb_bram_if_cntlr_Mem
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces nf_mbsys/mbsys/microblaze_0/Data] [get_bd_addr_segs nf_mbsys/mbsys/microblaze_0_axi_intc/S_AXI/Reg] SEG_microblaze_0_axi_intc_Reg
